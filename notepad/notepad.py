...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        open_file_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "open.png")), "Open", self
        )
        open_file_action.setStatusTip("Open File")
        open_file_action.setShortcut("Ctrl+O")
        open_file_action.triggered.connect(self.open_file)

        save_file_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "save.png")), "Save", self
        )
        save_file_action.setStatusTip("Save File")
        save_file_action.setShortcut("Ctrl+S")
        save_file_action.triggered.connect(self.save_file)

        save_as_file_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "save.png")), "Save as", self
        )
        ...
        print_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "print.png")), "Print", self
        )
        print_action.setStatusTip("Print current file")
        print_action.setShortcut("Ctrl+P")
        print_action.triggered.connect(self.print_file)

        undo_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "undo.png")), "Undo", self
        )
        undo_action.setStatusTip("Undo last change")
        undo_action.setShortcut("Ctrl+U")
        undo_action.triggered.connect(self.editor.undo)

        redo_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "redo.png")), "Redo", self
        )
        redo_action.setStatusTip("Redo last change")
        redo_action.setShortcut("Ctrl+R")
        redo_action.triggered.connect(self.editor.redo)

        cut_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "cut.png")), "Cut", self
        )
        cut_action.setStatusTip("Cut selected text")
        cut_action.setShortcut("Ctrl+X")
        cut_action.triggered.connect(self.editor.cut)

        copy_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "copy.png")), "Copy", self
        )
        copy_action.setStatusTip("Copy selected text")
        copy_action.setShortcut("Ctrl+C")
        copy_action.triggered.connect(self.editor.copy)

        paste_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "paste.png")), "Paste", self
        )
        paste_action.setStatusTip("Paste from clipboard")
        paste_action.setShortcut("Ctrl+V")
        paste_action.triggered.connect(self.editor.paste)

        select_action = qtw.QAction(
            qtg.QIcon(os.path.join("images", "select.png")), "Select All", self
        )
    ...
    def update_title(self):
        self.setWindowTitle(
            f"{(os.path.basename(self.path))} NotePad--"
            if self.path
            else "Untitled - NotePad--"
        )
    ...
    def open_file(self):
        path, _ = qtw.QFileDialog.getOpenFileName(
            self, "Open File", "", "Text documents (*.txt); All file (*.*)"
        )
    ...
    def save_as(self):
        path, _ = qtw.QFileDialog.getSaveFileName(
            self, "Save As", "", "Text documents (*.txt);; All files (*.*)"
        )
